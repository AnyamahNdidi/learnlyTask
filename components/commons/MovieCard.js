 ...
 * @component
 * @param {Object} props - Props for configuring the MovieCard.
 * @param {Object} props.props - Movie details, including title, genre, rank, year, rating, description, and image.
 * @returns {JSX.Element} Rendered MovieCard component.
 */
const MovieCard = ({ props }) => {
	 /**
   * Handles the click event when the user wants to view detailed information about the movie.
   * @function
