 ...
 * It retrieves user data from the session storage, updates it based on user input,
 * and saves the changes back to the session storage.
 */

const Profile = () => {
	 // State to manage user session data
	const [getSession, setGetSession] = useState({});

	// useEffect to retrieve user session data on component mount
	useEffect(() => {
	...
	// it's handle to update user profile and save changes to session storage
	const updateProfile = () => {
